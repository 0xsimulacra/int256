...
Portions are derived from holiman/uint256, licensed under BSD-3-Clause, and linhbkhn95/int256, licensed under MIT. See [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md).